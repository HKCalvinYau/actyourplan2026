...
export default function Home() {
  // 獲取所有文章並按日期排序（最新的在前）
  const allPosts = getAllPostsAllTypes()
        ...
        <section className="relative min-h-[80vh] flex items-center justify-center bg-surface">
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-heading font-bold mb-6 text-white leading-tight">
              建立你的基地。執行你的計畫。
              <br />
              <span className="uppercase">BUILD YOUR BASE. ACT YOUR PLAN.</span>
              <br className="hidden lg:block" />
              <span className="hidden lg:inline text-4xl md:text-5xl lg:text-6xl">基地を築け。計画を実行せよ。</span>
            </h1>
            ...
            <div className="text-gray-400 font-mono text-lg md:text-xl mb-12 max-w-4xl mx-auto">
              ...
              <p>
                這裡不是心靈雞湯。這是關於<strong className="text-primary">商業戰略</strong>、<strong className="text-primary">數位武裝</strong>與<strong className="text-primary">實戰藍圖</strong>的生存筆記。
              </p>
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
                ...
                <div className="font-mono text-sm space-y-4">
                  <div className="border-b border-border pb-2">
                    <span className="text-text-muted">REAL WORLD RANK:</span>{' '}
                    <span className="text-text-main">Commander (老闆/實業家)</span>
                  </div>
                  <div className="border-b border-border pb-2">
                    <span className="text-text-muted">DIGITAL RANK:</span>{' '}
