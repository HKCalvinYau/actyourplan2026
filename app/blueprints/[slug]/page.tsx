...
import { Calendar, Tag, FileText, Eye } from 'lucide-react'
...
export async function generateStaticParams() {
  const slugs = getAllSlugs('blueprints')
...
export async function generateMetadata({ params }: { params: { slug: string } }) {
  const post = getPostBySlug('blueprints', params.slug)
  ...
  return {
    title: `${post.title} | BLUEPRINTS`,
    description: post.description,
  }
}

export default function BlueprintPostPage({
  params,
}: {
  params: { slug: string }
}) {
  ...
  return (
    <div className="min-h-screen">
      <ViewTracker type="blueprints" slug={params.slug} />
